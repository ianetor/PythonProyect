...
class EditarPerfil():
    ...
    def __init__(self, perfil_actual):
        ...
        [sg.Text("Ingresa tu nick o alias:", pad=((30, 0), (20, 30)), font=('Helvetica', 15),background_color='white',text_color='black'),
         sg.Text(perfil_encontrado['nick'], pad=((10, 0), (20, 30)), font=('Helvetica', 15),background_color='white',text_color='black')],
            
        [sg.Text("Nombre:", pad=((30, 0), (20, 30)), font=('Helvetica', 15),background_color='white',text_color='black'),
         sg.Text(perfil_encontrado['nombre'], key='-nombre-',pad=((10, 0), (20, 30)), font=('Helvetica', 15),background_color='white',text_color='black'),
        ...
        [sg.Text("Ingresa tu edad:", pad=((30, 0), (10, 30)), font=('Helvetica', 15),background_color='white',text_color='black'),
         sg.Text(perfil_encontrado['edad'], key='-edad-', pad=((10, 0), (20, 30)), font=('Helvetica', 15),background_color='white',text_color='black'),
        ...
        [sg.Text('Género autopercibido:', pad=((30, 0), (10, 30)), font=('Helvetica', 15),background_color='white',text_color='black'),
         sg.Text(perfil_encontrado['genero'],key='-genero-', pad=((10, 0), (20, 30)), font=('Helvetica', 15),background_color='white',text_color='black'),
